    ...
    <div className={["OpenCapsule", theme].join(" theme")}>
      ...
      <div className="container">
        ...
        <div className="image_section">
          <img
            className={["img_isOpened", status === "OPENED"].join("_")}
            alt=""
            src={image_empty}
          />
          <div className={["ellipses", status === "OPENED"].join("_")}>
        ...
        <div className="text_section">
          ...
          <button className={["btn_isOpened", status === "OPENED"].join("_")}>
            {status === "OPENED" ? (
      ...
      <div className="create_new">
        ...
        <div
          ...
          onClick={isPcapsule ? handleCreateCapsule : handleCopyUrl}
        >
          <img alt="" src={image_add_background} />
          <img
            className={isPcapsule ? "add" : "share"}
            alt=""
